        ...
        <div class="display-table">
          <div class="display-table-cell">
            <div class="main-content">
              <h1 class="title">UNDIAN PAKET UMROH 
                <span id="counter">
...
<!--simpan data hidden-->
      ...
      <img src="<?php echo base_url('assets/undian/'); ?>images/bg-umroh.png" style="width:100%;height:100%">
...
//stop
    ...
    console.log(total_putar);
      ...
      console.log(nomer_kartu);
        $.ajax({
            ...
            type : "POST",
            data : { nomer_kartu:nomer_kartu, "category_hadiah" : 3},
            success : function(data) {
                // do something
                console.log(data);
                window.location = "<?php echo base_url(); ?>undian/daftar_pemenang?category_hadiah=3&putaran="+total_putar;
  ...
  function pemenangundian(){
    window.location.assign("<?php echo base_url(); ?>undian/daftar_pemenang?category_hadiah=3&putaran="+total_putar);
  }
