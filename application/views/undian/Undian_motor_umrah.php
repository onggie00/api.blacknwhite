        ...
        <div class="display-table">
          <div class="display-table-cell">
            <div class="main-content">
              <h1 class="title">UNDIAN Motor Dan Umrah
                <span id="counter">
...
mempertemukan semua individu yang ingin sukses dan bahagia.</p>
              ...
              <div id="play" class="btn_undian" onclick="random()" style="width:auto;">
                ...
                <h5 id="btn_play" ><span ><i class="ion-play"> &nbsp;&nbsp; </i></span> Putar Undian Untuk 6 Nomor</h5>
               </a>
              </div>
...
-->
  ...
  */
  ...
  if (total_putar==4) {
    document.getElementById('btn_play').innerHTML = "Putar Undian untuk 7 Nomor";
  }
...
//close random unique angka
   ...
   function random(){
    ...
    if (pencet==0) {
      ...
      document.getElementById("loading_undian").innerHTML = "<h5 style='font-weight:100;text-align:center'>Sistem sedang mengacak seluruh nomor di database untuk mendapatkan  pemenang</h5>";
      clearInterval(myVar);
    ...
    console.log(total_putar);
      ...
      console.log(nomer_kartu);
        ...
        $.ajax({
            url : "<?php echo base_url(); ?>undian/cobainsert",
            type : "POST",
            data : { nomer_kartu:nomer_kartu2, "category_hadiah" : 3},
            success : function(data) {
                // do something
                console.log(data);
