...
<body>
  <input type="hidden" id="putaran" value="<?php echo $total_putar; ?>">
	<div class="main-area">
        ...
        <?php 
            echo "<div class='kolom_pemenang' style='background-color:hsl(0, 0%, 90%);padding-left:20px;border-radius:5px;padding-bottom:20px;'>";
            echo "<h1 style='padding-top:30px;padding-bottom:15px;'>Nomor Kartu</h1>";
            $ctr = 1;
          foreach ($pemenang as $key => $value) {
            ...
            if ($ctr <=4) {
            echo "<div style='float:left;padding:5px 35px 10px 10px;font-size:13pt;font-weight:bold;'> ".$value->nomer_kartu."</div>";
            $ctr++;
            }else{
              echo "<div style='padding:5px 35px 10px 10px;font-size:13pt;font-weight:bold;'> ".$value->nomer_kartu."</div>";
              $ctr=1;
            }
          }
...
<!--Right Section-->
			<section class="right-section right-section-smartphone" style="">
