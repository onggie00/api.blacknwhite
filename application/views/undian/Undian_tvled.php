        ...
        <div class="display-table">
          <div class="display-table-cell">
            <div class="main-content">
              <h1 class="title">UNDIAN TV LED <span id="counter">
...
<!--simpan data hidden-->
      ...
      <section class="right-section" >
         <img src="<?php echo base_url('assets/undian/'); ?>images/bg-tvled.png" style="width:100%;height:100%">
  ...
  function stopundian(){
    ...
    if(total_putar<20){
      ...
      $.ajax({
          ...
          type : "POST",
          dataType : "json",
          data : {"nomer_kartu" : arr[ctr2], "category_hadiah" : 7},
...
/*      for (var i = 0; i < total_putar; i++) {
          ...
          type : "POST",
          dataType : "json",
          data : {"nomer_kartu" : arr[i], "category_hadiah" : 7},
          success : function(data) {
              // do something
  ...
  function pemenangundian(){
    window.location.assign("<?php echo base_url(); ?>undian/daftar_pemenang?category_hadiah=7");
  }
