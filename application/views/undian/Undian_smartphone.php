        ...
        <div class="display-table">
          <div class="display-table-cell">
            <div class="main-content">
              <h1 class="title" style="font-size:35pt;">UNDIAN SMARTPHONE 
                <span id="counter">
...
mempertemukan semua individu yang ingin sukses dan bahagia.</p>
              ...
              <div id="play" class="btn_undian" onclick="random()" style="width:auto;">
                ...
                <h5><span ><i class="ion-play"> &nbsp;&nbsp; </i></span> Putar Undian Untuk 25 Nomor</h5>
               </a>
              </div>
...
<!--simpan data hidden-->
      ...
      <img src="<?php echo base_url('assets/undian/'); ?>images/bg-smartphone.png" style="width:100%;height:100%">
...
//close random unique angka
   ...
   function random(){
    ...
    if (pencet==0) {
      ...
      document.getElementById("loading_undian").innerHTML = "<h5 style='font-weight:100;text-align:center'>Sistem sedang mengacak seluruh nomor di database untuk mendapatkan 25 pemenang</h5>";
      clearInterval(myVar);
...
//stop
    ...
    console.log(total_putar);
      ...
      console.log(nomer_kartu);
        $.ajax({
            ...
            type : "POST",
            data : { nomer_kartu:nomer_kartu, "category_hadiah" : 8},
            success : function(data) {
                // do something
                console.log(data);
                window.location = "<?php echo base_url(); ?>undian/daftar_pemenang?category_hadiah=8&putaran="+total_putar;
  ...
  function pemenangundian(){
    window.location.assign("<?php echo base_url(); ?>undian/daftar_pemenang?category_hadiah=8&putaran="+total_putar);
  }
