...
<body>
	...
	<div class="main-area">
		<div class="full-height position-static">
			...
			<section class="left-section-mesin_cuci full-height">
...
<!--Right Section-->
			<section class="right-section" style="background:#F3F3F3;width:45%;">
				 <div class="tabel-kanan" style="padding-right:240px;">
