        ...
        <div class="display-table">
          <div class="display-table-cell">
            <div class="main-content">
              <h1 class="title">UNDIAN KULKAS <span id="counter">
...
<!--simpan data hidden-->
      ...
      <section class="right-section" >
         <img src="<?php echo base_url('assets/undian/'); ?>images/bg-kulkas.png" style="width:100%;height:100%">
  ...
  function stopundian(){
    ...
    if(total_putar<15){
      ...
      $.ajax({
          ...
          type : "POST",
          dataType : "json",
          data : {"nomer_kartu" : arr[ctr2], "category_hadiah" : 5},
...
/*      for (var i = 0; i < total_putar; i++) {
          ...
          type : "POST",
          dataType : "json",
          data : {"nomer_kartu" : arr[i], "category_hadiah" : 5},
          success : function(data) {
              // do something
  ...
  function pemenangundian(){
    window.location.assign("<?php echo base_url(); ?>undian/daftar_pemenang?category_hadiah=5");
  }
