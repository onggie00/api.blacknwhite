...
<body >
  <input type="hidden" value="<?php echo $total_putar; ?>" id="putaran">
	<div class="main-area">
		<div class="full-height position-static">

			<section class="left-section-motor full-height">
...
<!--Right Section-->
			<section class="right-section" style="background:#F3F3F3;width:40%;">
				 <div class="tabel-kanan" style="padding-right:110px;">
          <div class="logo-daftar">
             <img src="<?php echo base_url('assets/undian/'); ?>images/gelaplogo.png" alt="Logo1">
          </div>
          <div class="layout_tabel_pemenang">
        <?php 
          ...
          foreach ($pemenang as $key => $value) {
            ...
            if ($ctr <=1) {
            echo "<div style='float:left;padding:5px 50px 10px 0px;font-size:18pt;font-weight:bold;'> ".$value->nomer_kartu."</div>";
            $ctr++;
            }else{
              echo "<div style='padding:5px 50px 10px 0px;font-size:18pt;font-weight:bold;'> ".$value->nomer_kartu."</div>";
              $ctr=1;
            }
          }
...
function motor(){
  window.location.assign("<?php echo base_url(); ?>undian/motor?putaran="+total_putar);
}
function kulkas(){
