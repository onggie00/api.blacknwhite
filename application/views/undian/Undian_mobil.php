        ...
        <div class="display-table">
          <div class="display-table-cell">
            <div class="main-content">
              <h1 class="title">UNDIAN MOBIL <span id="counter">
...
mempertemukan semua individu yang ingin sukses dan bahagia.</p>
              ...
              <div id="pemenang" class="btn_pemenang" onclick="pemenangundian()" style="width:320px !important;">
               <a class="btn btn-default" >
                <h5> Lanjut kehadiah Selanjutnya</h5>
               </a>
              </div>
<div class="ketentuan">
    <p><?php echo $syarat; ?></p>
...
<!--simpan data hidden-->
      ...
      <section class="right-section" >
         <img src="<?php echo base_url('assets/undian/'); ?>images/bg-mobil.png" style="width:100%;height:100%">
  ...
  function stopundian(){
    ...
    if(total_putar<2){
      ...
      $.ajax({
          ...
          type : "POST",
          dataType : "json",
          data : {"nomer_kartu" : arr[ctr2], "category_hadiah" : 2},
...
/*      for (var i = 0; i < total_putar; i++) {
          ...
          type : "POST",
          dataType : "json",
          data : {"nomer_kartu" : arr[i], "category_hadiah" : 2},
          success : function(data) {
              // do something
