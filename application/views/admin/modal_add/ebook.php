<div class="modal" id="modal_add_data" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content Roboto" style="color: #000;border-radius: 0px;margin-top: 10%;">
      ...
      <form class="form-horizontal form-label-left" action="<?php echo site_url('admin/ebook/insert_data') ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="col-lg-12">
                  ...
                  <div class="row">
                    <div class="col-md col-xs" >
                      ...
                      <div class="row">
                        <input type="file" id="pdf" class="form-control" required
                        style="background:#EFEFEF;width:100%;" name="pdf" value=""  accept="application/pdf">
                      </div>
                    </div>
                    <div class="col-md col-xs" style="width:49%;margin-left:2%">
                      ...
                      <div class="row">
                        ...
                        <?php foreach ($this->mymodel->getall('ebook_category') as $key => $value): ?>
                          <option value="<?php echo $value->id_ebook_category ?>"><?php echo $value->name ?></option>
                        <?php endforeach; ?>
                        </select>
                    </div>
                    </div>
