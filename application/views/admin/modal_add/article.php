<div class="modal" id="modal_add_data" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-md">
    <div class="modal-content Roboto" style="color: #000;border-radius: 0px;margin-top: 10%;">
      ...
      <form class="form-horizontal form-label-left" action="<?php echo site_url('admin/article/insert_data') ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-md col-xs" >
                      ...
                      <div class="row">
                        ...
                        <?php foreach ($this->mymodel->getall('article_category') as $key => $value): ?>
                          <option value="<?php echo $value->id_article_category ?>"><?php echo $value->name ?></option>
                        <?php endforeach; ?>
                        </select>
                    </div>
                    </div>
