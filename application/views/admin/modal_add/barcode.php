<div class="modal" id="modal_add_data" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-md">
    <div class="modal-content Roboto" style="color: #000;border-radius: 0px;margin-top: 10%;">
      ...
      <form class="form-horizontal form-label-left" action="<?php echo site_url('admin/barcode/insert_data') ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-lg-12" >
                      <div class="row">
                        <div class="col" style="text-align:left;">
                          <p style="margin-left:-10px;font-weight:bold;">Jumlah barcode</p>
                        </div>
                      ...
                      <div class="row">
                        <input type="number" id="title" required="required" class="form-control"
                        style="background:#EFEFEF;width:100%;" name="jumlah_barcode" value=""
                        min="1" maxlength="100" >
                      </div>
                    </div>
                  </div>
