<div class="modal" id="modal_add_data" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-md">
    <div class="modal-content Roboto" style="color: #000;border-radius: 0px;margin-top: 10%;">
      ...
      <form class="form-horizontal form-label-left" action="<?php echo site_url('admin/undian/insert_data') ?>" method="post" enctype="multipart/form-data">
                  ...
                  <div class="row">
                    <div class="col-md col-xs" >
                        ...
                        <div class="row">
                          ...
                          placeholder="Nomor sesuai kartu" maxlength="100" >
                         </div>
                    </div>
                    <div class="col-md col-xs" >
                        <div class="row">
                        ...
                        <div class="row">
                          <input type="text" id="hadiah" required="required" class="form-control"
                          style="background:#EFEFEF;width:100%;" name="hadiah" value=""
