...
<form class="form-horizontal form-label-left" action="<?php echo site_url('admin/article/update_data') ?>" method="post" enctype="multipart/form-data">
  <input type="hidden" name="id_data" value="<?php echo $data->id_article ?>">
          ...
          <div class="col-lg-12">
              ...
              <div class="col-md col-xs" >
                <div class="row">
                  <div class="col-md col-xs" style="text-align:left;">
                    <p style="margin-left:-10px;font-weight:bold;">Nama Artikel</p>
                  </div>
                ...
                <div class="row">
                  ...
                  placeholder="article 1" maxlength="100" >
                </div>
              </div>
              <div class="col-md col-xs" >
                <div class="row">
                  <div class="col-md col-xs" style="text-align:left;">
                    <p style="margin-left:-10px;font-weight:bold;">Foto Artikel</p>
                  </div>
                  <div class="col-md col-xs" style="color:#CACACA;text-align:right;">
                  </div>
                </div>
            ...
            <div class="row">
              <div class="col-md col-xs" >
                <div class="row">
                  <div class="col-md col-xs" style="text-align:left;">
                    <p style="margin-left:-10px;font-weight:bold;">Kategori Artikel</p>
                  </div>
                  <div class="col-md col-xs" style="color:#CACACA;text-align:right;">
                ...
                <div class="row">
                  ...
                  style="background:#EFEFEF;width:100%;"  name="id_article_category">
                  <?php foreach ($this->mymodel->getall('article_category') as $key => $value): ?>
                    <option value="<?php echo $value->id_article_category ?>"
                      <?php if ($value->id_article_category==$data->id_article_category): ?>
                        selected
                      <?php endif; ?>
            ...
            <div class="row">
              <div class="col-md col-xs" style="width:99%;">
                <div class="row">
                  <div class="col-md col-xs" style="text-align:left;">
                    <p style="margin-left:-10px;font-weight:bold;">Deskripsi Artikel</p>
                  </div>
                  <div class="col-md col-xs" style="color:#CACACA;text-align:right;">
