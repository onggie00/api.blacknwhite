...
<form class="form-horizontal form-label-left" action="<?php echo site_url('admin/chat_category/update_data') ?>" method="post">
  <input type="hidden" name="id_data" value="<?php echo $data->id_chat_category ?>">
