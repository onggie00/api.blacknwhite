...
<form class="form-horizontal form-label-left" action="<?php echo site_url('admin/event_video/update_data') ?>" method="post" enctype="multipart/form-data">
  <input type="hidden" name="id_data" value="<?php echo $data->id_event_video ?>">
          ...
          <div class="col-lg-12">
            <div class="row">
              ...
              <div class="col-md col-xs" >
                ...
                <div class="row">
                  <input type="file" id="vid" class="form-control"
