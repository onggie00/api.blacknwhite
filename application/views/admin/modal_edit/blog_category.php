...
<form class="form-horizontal form-label-left" action="<?php echo site_url('admin/blog_category/update_data') ?>" method="post">
  <input type="hidden" name="id_data" value="<?php echo $data->id_blog_category ?>">
