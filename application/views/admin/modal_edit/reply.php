...
<form class="form-horizontal form-label-left" action="<?php echo site_url('admin/admin_message/reply') ?>" method="post" enctype="multipart/form-data">
          ...
          <div class="col-lg-12">
                  ...
                  <div class="row">
                    <div class="col-md col-xs" >
                      <div class="row">
                        <div class="col-md col-xs" style="text-align:left;">
                          <p style="margin-left:-10px;font-weight:bold;">Subject</p>
                        </div>
                        <div class="col-md col-xs" style="color:#CACACA;text-align:right;">
