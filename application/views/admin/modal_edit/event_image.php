...
<form class="form-horizontal form-label-left" action="<?php echo site_url('admin/event_image/update_data') ?>" method="post" enctype="multipart/form-data">
  <input type="hidden" name="id_data" value="<?php echo $data->id_event_image ?>">
              ...
              <div class="col-md col-xs" >
                <div class="row">
                  <div class="col-md col-xs" style="text-align:left;">
                    <p style="margin-left:-10px;font-weight:bold;">Foto image</p>
                  </div>
