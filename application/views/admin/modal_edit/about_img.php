...
<form class="form-horizontal form-label-left" action="<?php echo site_url('admin/about_img/update_data') ?>" method="post" enctype="multipart/form-data">
  <input type="hidden" name="id_data" value="<?php echo $data->id_about_img ?>">
