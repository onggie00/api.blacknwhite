        ...
        <div class="col-12">
          <div class="box">
            <div class="box-header">
              <div class="col-4" style="cursor:pointer;border-bottom: 4px solid #dd4124;" onclick="add_data()">
                <p><i class="fa fa-plus" ></i> <b>TAMBAH DATA</b>  </p>
              </div>
              <br>
              <a href="<?php echo site_url("admin/barcode/exportexcel"); ?>">
            ...
            <div class="box-body">
              ...
              <div class="table-responsive">
                <?php $this->load->view('admin/table_data/table_barcode') ?>
              </div>
  ...
  $(document).ready(function(){
       var dataTable = $('#data').DataTable({
           // "dom": 'Bfrtip',
         		...
         		// ],
            oLanguage: {
              sProcessing: "<center><img src='<?php echo base_url() ?>/assets/img/loader/Facebook.gif'></center>"
            }, 
            "processing":true,
            "serverSide":true,
            "order":[],
            "ajax":{
                 url:"<?php echo base_url() .'admin/barcode/alldata'; ?>",
                 type:"POST"
            },
            "columnDefs":[
                 {
   ...
   $(document).on("click", ".delete", function(e) {
        ...
        $(document).on('click', '.update', function(){
            var a = $(this).attr("id");
            $.post('<?php echo site_url('apiv2/admin/barcode/getdataedit') ?>',
            {id :a},function (data) {
              if (data!="" || data != null) {
