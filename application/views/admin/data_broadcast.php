          ...
          <div class="box">
            ...
            <div class="box-body">
              ...
              <div class="table-responsive">
                <?php $this->load->view('admin/table_data/table_broadcast') ?>
              </div>
...
<!-- ./wrapper -->
  ...
  $(document).ready(function(){
       var dataTable = $('#data').DataTable({
            ...
            "order":[],
            "ajax":{
                 url:"<?php echo base_url() .'admin/broadcast/alldata/'; ?>",
                 type:"POST"
            },
            "columnDefs":[
                 {
  ...
  function edit_data(a) {
    $.post('<?php echo site_url('admin/broadcast/getdataedit') ?>',
    {id :a},function (data) {
      if (data!="" || data != null) {
