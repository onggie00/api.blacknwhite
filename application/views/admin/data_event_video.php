          ...
          <div class="box">
            ...
            <div class="box-body">
              ...
              <div class="table-responsive">
                <?php $this->load->view('admin/table_data/table_event_video') ?>
              </div>
  ...
  $(document).ready(function(){
       var dataTable = $('#data').DataTable({
           // "dom": 'Bfrtip',
            ...
            "order":[],
            "ajax":{
                 url:"<?php echo base_url() .'admin/event_video/alldata/'.$mydata->id_event; ?>",
                 type:"POST"
            },
            "columnDefs":[
                 {
   ...
   $(document).on("click", ".delete", function(e) {
        ...
        $(document).on('click', '.update', function(){
            var a = $(this).attr("id");
            $.post('<?php echo site_url('admin/event_video/getdataedit') ?>',
            {id :a},function (data) {
              if (data!="" || data != null) {
