          ...
          <div class="box">
            <div class="box-header">
              <div class="col-lg-3" style="cursor:pointer;border-bottom: 4px solid #dd4124;" onclick="add_data()">
                <p><i class="fa fa-plus" ></i> <b>TAMBAH PAKET</b>  </p>
              </div>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              ...
              <div class="table-responsive">
                <?php $this->load->view('admin/table_data/table_paket') ?>
              </div>
...
<!-- ./wrapper -->
  ...
  $(document).ready(function(){
       var dataTable = $('#data').DataTable({
            ...
            "order":[],
            "ajax":{
                 url:"<?php echo base_url() .'apiv2/admin/paket/alldata'; ?>",
                 type:"POST"
            },
            "columnDefs":[
                 {
   ...
   $(document).on("click", ".delete", function(e) {
        ...
        $(document).on('click', '.update', function(){
            var a = $(this).attr("id");
            $.post('<?php echo site_url('apiv2/admin/paket/getdataedit') ?>',
            {id :a},function (data) {
              if (data!="" || data != null) {
