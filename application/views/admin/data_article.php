          ...
          <div class="box">
            ...
            <div class="box-body">
              ...
              <div class="table-responsive">
                <?php $this->load->view('admin/table_data/table_article') ?>
              </div>
  ...
  $(document).ready(function(){
       var dataTable = $('#data').DataTable({
           // "dom": 'Bfrtip',
            ...
            "order":[],
            "ajax":{
                 url:"<?php echo base_url() .'admin/article/alldata'; ?>",
                 type:"POST"
            },
            "columnDefs":[
                 {
   ...
   $(document).on("click", ".delete", function(e) {
        ...
        $(document).on('click', '.update', function(){
            var a = $(this).attr("id");
            $.post('<?php echo site_url('admin/article/getdataedit') ?>',
            {id :a},function (data) {
              if (data!="" || data != null) {
