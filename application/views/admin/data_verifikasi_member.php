<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <?php $this->load->view('admin/modal_add/verifikasi_member') ?>
    <!-- delete -->
    <button type="button" class="d-none" data-toggle="modal" data-target=".bs-example-modal-sm" id="del">de</button>
    <?php $this->load->view('admin/modal_delete/verifikasi_member') ?>
    <!-- edit -->
          ...
          <div class="box">
            ...
            <div class="box-body">
              ...
              <div class="table-responsive">
                <?php $this->load->view('admin/table_data/table_verifikasi_member') ?>
              </div>
...
<!-- ./wrapper -->
  ...
  $(document).ready(function(){
       var dataTable = $('#data').DataTable({
            ...
            "order":[],
            "ajax":{
                 url:"<?php echo base_url() .'admin/verifikasi_member/alldata'; ?>",
                 type:"POST"
            },
            "columnDefs":[
                 {
   ...
   $(document).on("click", ".delete", function(e) {
        ...
        $(document).on('click', '.update', function(){
            var a = $(this).attr("id");
            $.post('<?php echo site_url('admin/verifikasi_member/getdataedit') ?>',
            {id :a},function (data) {
              if (data!="" || data != null) {
