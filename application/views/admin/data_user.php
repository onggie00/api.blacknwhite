      ...
      <div class="row">
        <div class="col-12">
          <div class="box">
            ...
            <div class="col-lg-3">
              <form action="<?php echo site_url("admin/Export_user_custom/exportexcel/")?>" method="POST">
                <p>Masukkan Nomor Barcode (Min) : &nbsp;<input type="text" name="min_nomor" /></p>
                <p>Masukkan Nomor Barcode (Max) : <input type="text" name="max_nomor" /></p>
                <div class="box-header">
                <input name="btn_export" style="cursor:pointer;background-color:transparent;border-color:transparent;" type="submit" value="EXPORT DATA">
                </input>
                  <div class="col-8" style="cursor:pointer;color:#000;border-bottom: 4px solid #0000ff;">
                  </div>
                </div>
              </form>
            </div>
            <!--<div class="box-header">
              <a href="<?php echo site_url("admin/Export_user/exportexcel/$min_nomor/$max_nomor"); ?>">
