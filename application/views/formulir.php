        ...
        <div class="row">
          <div class="col-xs-12" style="background: #D4C8BD;padding:0px;">
            ...
            <div class="row" style="margin-top:25px;">
                ...
                <div class="col-xs-3">
                     <input id="nama" class="form-control"  name="nama" required type="text" value="<?php echo $jemaah->reff_id ?>">
                </div>
                <div class="col-xs-2" style="margin-left:10%;">
                  <b>Customer. ID :</b>
                </div>
                <div class="col-xs-3" style="margin-left:-5%;">
                     <input id="nama" class="form-control"  name="nama" required type="text" value="<?php echo $jemaah->id_jemaah ?>">
                </div>
            </div>
                ...
                <div class="col-xs-5">
                  ...
                  <div style="width:100%;margin-top:5px;text-align:center;font-size:12px;">
                    <div style="color:#fff;width:48%;float:left;">
                      <?php if ($jemaah->id_gender==1): ?>
                        <div style="background:#000;foreground:#000;float:left;width:20%;margin-left:20px;height:20px;">
                        </div>
                        <?php else: ?>
                    ...
                    <div style="width:100%;margin-top:5px;text-align:center;font-size:12px;">
                      <div style="color:#fff;width:48%;float:left;">
                        <?php if ($jemaah->id_usianikah==2): ?>
                          <div style="background:#000;foreground:#000;float:left;width:20%;margin-left:20px;height:20px;">
                          </div>
                          <?php else: ?>
                            <div style="background:#fff;foreground:#fff;float:left;width:20%;margin-left:20px;height:20px;border:1px solid black">
                            </div>
                        <?php endif; ?>
                        <div style="color:#fff;float:left;width:50%;text-align:center;">
                      ...
                      <div style="color:#fff;width:50%;float:left;">
                        <?php if ($jemaah->id_usianikah==4): ?>
                          <div style="background:#000;foreground:#000;float:left;width:20%;margin-left:20px;height:20px;">
                          </div>
                          <?php else: ?>
                            <div style="background:#fff;foreground:#fff;float:left;width:20%;margin-left:20px;height:20px;">
                            </div>
                        <?php endif; ?>
                        <div style="color:#fff;float:left;width:60%;text-align:center;">
                    ...
                    <div style="width:100%;margin-top:5px;text-align:center;font-size:12px;">
                      <div style="color:#fff;width:48%;float:left;">
                        ...
                        <?php endif; ?>
                        <div style="color:#fff;float:left;width:50%;text-align:center;padding-left:5px;">
                           <label class="" for="nama" > 5 - 10 tahun</label>
                        </div>
                      </div>
                      <div style="color:#fff;width:50%;float:left;">
                        <?php if ($jemaah->id_usianikah==5): ?>
                          <div style="background:#000;foreground:#000;float:left;width:20%;margin-left:20px;height:20px;">
                          </div>
                          <?php else: ?>
                            <div style="background:#fff;foreground:#fff;float:left;width:20%;margin-left:20px;height:20px;border:1px solid black">
                    ...
                    <div class="col-xs-11" style="color:#fff;">
                      ...
                      <input type="tel" id="ktp" name="ktp" required class="form-control " value="<?php echo $jemaah->ktp ?>">

                    </div>
                    <div class="col-xs-11" style="color:#fff;">
                      <label class="pull-left" for="alamatktp">Alamat Sesuai KTP :</label>
                      <textarea type="text" id="alamatktp" name="alamatktp" required class="form-control "
                      style="margin-top:5px;height:60px;font-size:12px;" cols="100">
                      <?php echo $alamatktp->alamat ?>
                      </textarea>
                    </div>
                    <div style="width:100%;margin-top:5px;text-align:center;font-size:10px;">
                      <div style="color:#fff;width:45%;float:left;">
                        ...
                        <div style="color:#fff;float:left;width:20%;text-align:center;">
                          <textarea type="text" id="alamatktp" name="alamatktp" required class="form-control "
                          style="margin-top:5px;height:30px;font-size:10px;" cols="100">
                          <?php if($alamatktp->no!=0) echo $alamatktp->no; else echo "-";?>
                          </textarea>
                        </div>
                      </div>
                ...
                <div class="col-xs-5 col-xs-offset-1">
                  <div class="item form-group">
                    <div class="col-xs-11" style="color:#fff;margin-left:-15px;">
                      <label class="pull-left" for="alamatktp">Alamat Tinggal Sekarang :</label>
                      <textarea type="text" id="alamatktp" name="alamatktp" required class="form-control "
                      style="margin-top:5px;height:60px;font-size:12px;" cols="100">
                    ...
                    <div style="width:100%;margin-top:5px;text-align:center;font-size:10px;">
                      <div style="color:#fff;width:45%;float:left;">
                        ...
                        <div style="color:#fff;float:left;width:20%;text-align:center;">
                          <textarea type="text" id="alamatktp" name="alamatktp" required class="form-control "
                          style="margin-top:5px;height:30px;font-size:10px;" cols="100">
                          <?php if($alamat->no!=0) echo $alamat->no; else echo "-";?>
                          </textarea>
                        </div>
                      </div>
                      <div style="color:#fff;width:45%;float:left;margin-left:-30%;">
                    ...
                    <div class="col-xs-11" style="color:#fff;margin-left:-15px;">
                      <?php $paket = $this->paket_umroh->getbyid($jemaah->id_paket) ?>
                      <label class="pull-left" for="paketumroh">Pilihan Paket Umroh :</label>
                      <textarea type="text" id="alamatktp" name="alamatktp" required class="form-control "
                      style="margin-top:5px;height:40px;font-size:12px;" cols="100">
                      <?php echo $paket->paket ?>
                      </textarea>
